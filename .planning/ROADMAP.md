...
Plans:
- [ ] 07-01-PLAN.md — Database schema: submissions table, roles enum, rate limiting setup
- [ ] 07-02-PLAN.md — Submission form UI with duplicate detection and i18n
- [ ] 07-03-PLAN.md — Server Actions for submit, edit, delete with rate limiting
...
|-------|----------------|--------|-----------|
| 7. Cafe Submissions | 0/4 | ○ Not Started | — |
