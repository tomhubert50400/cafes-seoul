...
export const translations: Record<LanguageCode, Record<string, string>> = {
  ...
  fr: {
    ...
    'admin.submissions.title': 'Propositions de cafes en attente',
    'admin.submissions.empty': 'Aucune proposition en attente',
    'admin.table.name': 'Nom du cafe',
    'admin.table.address': 'Adresse',
    'admin.table.submitter': 'Soumis par',
    'admin.table.date': 'Date',
    'admin.table.actions': 'Actions',
    'admin.approve.title': 'Approuver la proposition',
    'admin.approve.confirm': 'Cela creera un nouveau cafe a partir de cette proposition.',
    ...
    'admin.reject.reasonPlaceholder': 'Ex: Cafe en double, adresse inexacte...',
    'admin.reject.reasonRequired': 'La raison doit contenir au moins 10 caracteres',
    'admin.reject.notes': 'Notes admin (usage interne)',
    'admin.reject.button': 'Rejeter',
    'admin.edit.title': 'Modifier',
    'admin.edit.name': 'Nom du cafe',
    'admin.edit.address': 'Adresse',
    'admin.edit.phone': 'Telephone',
    'admin.edit.save': 'Enregistrer les modifications',
    'admin.success.approved': 'Proposition approuvee avec succes',
    'admin.success.rejected': 'Proposition rejetee',
    'admin.success.edited': 'Proposition mise a jour',
    ...
    'admin.success.photoApproved': 'Photo approuvee',
    'admin.success.photoRejected': 'Photo rejetee',
    'admin.stats.submissions': 'Propositions de cafes',
    'admin.stats.photos': 'Photos',
    'admin.stats.pending': 'En attente',
    'admin.stats.approved': 'Approuve',
    'admin.stats.declined': 'Refuse',
    'admin.stats.rejected': 'Rejete',
    'admin.activity.title': 'Activite recente',
    'admin.activity.empty': 'Aucune activite de moderation recente',
    'admin.activity.approved': 'Approuve',
    'admin.activity.rejected': 'Rejete',
    'admin.cafes.title': 'Gerer les cafes',
    'admin.cafes.subtitle': 'Voir et supprimer les cafes approuves',
    'admin.cafes.empty': 'Aucun cafe trouve',
    'admin.cafes.search': 'Rechercher par nom ou adresse...',
    'admin.cafes.noResults': 'Aucun cafe ne correspond a votre recherche',
    'admin.table.rating': 'Note',
    'admin.table.reviews': 'Avis',
    'admin.delete.button': 'Supprimer',
    'admin.delete.title': 'Supprimer le cafe',
    'admin.delete.confirm': 'Voulez-vous vraiment supprimer ce cafe? Cette action est irreversible. Toutes les photos, avis et favoris associes seront egalement supprimes.',
    'admin.delete.success': 'Cafe supprime avec succes',
    'admin.delete.error': 'Echec de la suppression du cafe',
    ...
    'dashboard.welcome.browse': 'Parcourir les cafes',
    'dashboard.welcome.submit': 'Soumettre un cafe',
    'dashboard.cafes.title': 'Soumissions de cafes',
    'dashboard.cafes.empty': 'Aucune soumission de cafe',
    'dashboard.ratings.title': 'Evaluations donnees',
    'dashboard.ratings.avg': 'moy',
    'dashboard.ratings.empty': 'Aucune evaluation',
    'dashboard.photos.title': 'Photos telechargees',
    'dashboard.photos.empty': 'Aucune photo telechargee',
    'dashboard.status.pending': 'En attente',
    'dashboard.status.approved': 'Approuve',
    'dashboard.status.declined': 'Refuse',
    'dashboard.status.rejected': 'Rejete',
    'dashboard.cafes.emptyCta': 'Soumettre un cafe',
    'dashboard.ratings.emptyCta': 'Parcourir les cafes',
    ...
    'reviews.card.edited': 'Modifie',
    'reviews.card.reviewSaved': 'Avis enregistre',
    'reviews.card.reviewDeleted': 'Avis supprime',
    'reviews.card.saveError': 'Echec de l\'enregistrement',
    'reviews.card.deleteError': 'Echec de la suppression',
    'reviews.card.deleteTitle': 'Supprimer le texte de l\'avis ?',
    'reviews.card.deleteDescription': 'Le texte de votre avis sera supprime mais votre note sera conservee. Tous les votes utiles seront supprimes.',
    'reviews.card.reviewPlaceholder': 'Partagez votre experience dans ce cafe...',
    'reviews.card.charactersRemaining': '{count} caracteres restants',
    ...
    'reviews.cafe.noReviews': 'Pas encore d\'avis. Soyez le premier a partager vos impressions !',
    'reviews.cafe.edited': 'Modifie',
    ...
    'reviews.cafe.voteError': 'Erreur lors de la mise a jour du vote',
    ...
    // Roulette
    'nav.roulette': 'Roulette',
    'roulette.title': 'Roulette Cafe',
    'roulette.subtitle': 'Laissez le destin choisir votre prochain cafe',
    ...
    'roulette.spinAgain': 'Tourner a nouveau',
    'roulette.adjustFilters': 'Filtres',
    'roulette.noResults': 'Aucun cafe ne correspond a vos filtres',
    'roulette.noResultsHint': 'Essayez d\'ajuster ou de reinitialiser vos filtres',
    'roulette.clearFilters': 'Reinitialiser',
    'roulette.matchedFilters': 'Filtres correspondants',
    'roulette.cafeCount': '{{count}} cafes disponibles',
    ...
    'cafes.rouletteCta': 'Toujours indecis ? Essayez la roue',

    // Vibes
    'vibes.title': 'Mes Ambiances',
    'vibes.description': 'Personnalisez vos presets de filtre',
    'vibes.createButton': 'Creer une ambiance',
    'vibes.createTitle': 'Creer une ambiance',
    'vibes.editTitle': 'Modifier l\'ambiance',
    'vibes.customizeTitle': 'Personnaliser le preset',
    'vibes.modalDescription': 'Definissez un nom, une icone et des filtres',
    'vibes.nameLabel': 'Nom',
    'vibes.namePlaceholder': 'Mon ambiance',
    'vibes.iconLabel': 'Icone',
    ...
    'vibes.reset': 'Reinitialiser',
    'vibes.customized': 'personnalise',
    'vibes.saveSuccess': 'Ambiance enregistree',
    'vibes.saveError': 'Echec de l\'enregistrement',
    'vibes.deleteSuccess': 'Ambiance supprimee',
    'vibes.deleteError': 'Echec de la suppression',
    'vibes.resetSuccess': 'Preset reinitialise',
    'vibes.resetError': 'Echec de la reinitialisation',
    'vibes.deleteConfirmTitle': 'Supprimer l\'ambiance ?',
    'vibes.deleteConfirmDescription': 'Cette action est irreversible.',
  },
