const ko: Record<string, string> = {
  ...
  'submissions.form.cantFindCafe': '카페를 찾을 수 없나요? 네이버 지도 링크를 붙여넣으세요',
  'submissions.form.linkPlaceholder': '네이버 지도 공유 링크를 붙여넣으세요...',
  'submissions.form.linkLookup': '조회',
  'submissions.form.linkInvalidUrl': '유효한 네이버 지도 링크를 붙여넣어 주세요.',
  'submissions.form.linkNotFound': '이 링크에서 카페 정보를 찾을 수 없습니다. URL을 확인하고 다시 시도해 주세요.',
  'submissions.form.backToSearch': '검색으로 돌아가기',
  'submissions.form.noResults': '카페를 찾을 수 없습니다. 다른 검색어를 시도해 보세요.',
  ...
  'submissions.form.fetchingHours': '네이버에서 영업시간 가져오는 중...',
  ...
  'submissions.duplicateNaver.existsInDirectory': '이 카페는 이미 등록되어 있습니다.',
  'submissions.duplicateNaver.alreadySubmitted': '이 카페는 이미 제출되었으며 검토 대기 중입니다.',
