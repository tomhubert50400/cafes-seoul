    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {t('photos.upload.description') || 'Share a photo of this cafe. Photos will be reviewed before appearing publicly.'}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {t('photos.upload.select') || 'Click to select a photo'}
                  </span>
          ...
          <p className="text-xs text-muted-foreground text-center">
            {t('photos.upload.disclaimer') || 'By uploading, you agree that your photo will be reviewed for quality and relevance. Approved photos will be visible to all users.'}
          </p>
        </div>
      </DialogContent>
    </Dialog>
